...
export default async function PersonalCategorizePage() {
  ...
  const completeness = await categorizationCompleteness(admin, "personal");
  ...
  return (
    <CategorizeView
      ...
      uncategorized={(uncat || []) as unknown as Parameters<
        typeof CategorizeView
      >[0]["uncategorized"]}
